                    ...
                    <Card className={'w-full md:w-1/2 dark:bg-gray-800 dark:border-gray-700'}>
                        <CardContent className={'p-4'}>
                            <div className={'relative h-[30vh] md:h-[40vh]'}>
                                ...
                                <div className={'absolute inset-0 flex items-center justify-between p-4'}>
                                    <Button variant={'outline'} size={'icon'} onClick={prevSlide} className={'bg-white bg-opacity-50 hover:bg-opacity-75 dark:bg-gray-700 dark:bg-opacity-50'}>
                                        <ChevronLeft size={24} />
                                    </Button>
                                    <Button variant={'outline'} size={'icon'} onClick={nextSlide} className={'bg-white bg-opacity-50 hover:bg-opacity-75 dark:bg-gray-700 dark:bg-opacity-50'}>
                                        <ChevronRight size={24} />
                                    </Button>
                                </div>
                            </div>
