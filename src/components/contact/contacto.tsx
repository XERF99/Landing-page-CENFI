  ...
  return (
    <div className={'container mx-auto px-4 py-12 my-2 bg-gradient-to-b from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 min-h-screen'}>
      ...
      <div className={'grid md:grid-cols-2 gap-8'}>
        ...
        >
          <Card className={'p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-gray-800 dark:text-white'}>
            <CardContent>
              <h2 className={'text-2xl font-semibold mb-6 text-blue-900 dark:text-white'}>Información de contacto</h2>
              ...
              <h3 className={'text-xl font-semibold mt-8 mb-6 text-blue-900 dark:text-white'}>Redes sociales</h3>
              <div className={'flex space-x-6'}>
        ...
        >
          <Card className={'pt-6 pr-6 pl-6 pb-1 shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-gray-800 dark:text-white'}>
            <CardContent>
              <h2 className={'text-2xl font-semibold mb-6 text-blue-900 dark:text-white'}>Envíanos un mensaje</h2>
              <form className={'space-y-4'}>
      ...
      >
        <Card className={'p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 dark:bg-gray-800 dark:text-white'}>
          <CardContent>
            <h2 className={'text-2xl font-semibold mb-6 text-blue-900 dark:text-white'}>Nuestra ubicación</h2>
