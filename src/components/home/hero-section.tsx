        ...
        <div className={'grid md:grid-cols-2 gap-8 items-center'}>
          ...
          >
            <Image
              ...
              width={700}
              height={600}
              className={'rounded p-1 shadow-xl shadow-blue-500/50'}
            />
            <div className={'absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg shadow-cyan-500/50'}>
...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className={'min-h-[50vh] bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-800 dark:to-gray-900 flex items-center mt-2'}>
      <div className={'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'}>
        <div className={'grid md:grid-cols-2 gap-8 items-center'}>
          <motion.div
            initial={{ opacity: 0, x: -50 }}
          ...
          <motion.div
            ...
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.8 }}
            className={'relative md:block order-first md:order-none'}
          >
            <Image
              src={'/hero-section-dark.png'}
              alt={'Estudiantes mostrando sus resultados'}
            ...
            />
            <div className={'absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg shadow-cyan-500/50 hidden md:block'}>
              <h3 className={'text-sm font-semibold text-blue-900 dark:text-white mb-2'}>Nuestros servicios</h3>
              <ul className={'space-y-1 text-sm'}>
                <li className={'flex items-center text-blue-700 dark:text-gray-300'}>
                  <CheckCircle className={'mr-2 h-4 w-4 text-green-500'} /> Tutorías
        ...
        <div className={'grid md:grid-cols-2 gap-8 items-center'}>
          ...
          >
            <Image
              ...
              className={'rounded p-1 shadow-xl shadow-blue-500/50 w-full h-auto md:w-auto'}  
            />
            <div className={'absolute  -bottom-6 -left-6 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg shadow-cyan-500/50 mt-4 md:w-auto'}>
              <h3 className={'text-sm font-semibold text-blue-900 dark:text-white mb-2'}>Nuestros servicios</h3>
              <ul className={'space-y-1 text-sm'}>
                <li className={'flex items-center text-blue-700 dark:text-gray-300'}>
                  <CheckCircle className={'mr-2 h-4 w-4 text-green-500'} /> Tutorías
...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className={'lg:min-h-[50vh] md:min-h-[30vh] bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-800 dark:to-gray-900 flex items-center mt-2'}>
      <div className={'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'}>
        <div className={'grid md:grid-cols-2 gap-8 items-center'}>
          <motion.div
            initial={{ opacity: 0, x: -50 }}
